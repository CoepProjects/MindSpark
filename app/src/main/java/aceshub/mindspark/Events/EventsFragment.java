...
public class EventsFragment extends Fragment {
    ...
    private void createEventsData() {
        ...
        EventsSingleItem codeJunkiePlusPlus=new EventsSingleItem(R.drawable.codejunkie,"Code junkie++",getString(R.string.event_objective_code_junkie_pp),getString(R.string.event_structure_code_junkie_pp),getString(R.string.event_rules_code_junkie),getString(R.string.event_heads_code_junkie_pp)+"\n"+getString(R.string.event_tafs_code_junkie_pp));
        ...
        EventsSingleItem encrypto=new EventsSingleItem(R.drawable.encrypto,"Encrypto",getString(R.string.event_objective_encrypto),getString(R.string.event_structure_encrypto),getString(R.string.event_rules_encrypto),getString(R.string.event_rules_encrypto)+"\n"+getString(R.string.event_tafs_encrypto));
        ...
        CategoriesSingleItem vortex=new CategoriesSingleItem(R.drawable.vortex,"Vortex",Arrays.asList(wheelomation,contraption,aqualympics,theWrightTurnGlider,theWrightTurnRC),R.color.red300);
        CategoriesSingleItem papyrus=new CategoriesSingleItem(R.drawable.papyrus,"Papyrus",Arrays.asList(ppt_civil,ppt_comp_it,ppt_eei,ppt_mech_prod,byldan),R.color.orange500);
        ...
        CategoriesSingleItem fascinus=new CategoriesSingleItem(R.drawable.fascinus,"Fascinus",Arrays.asList(theAmazingRace,bidzkrieg_1,LANSlam,bullRun,flash),R.color.brown400);
